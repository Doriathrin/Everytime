<template>
  <div class="my-study-list">
    <div v-for="(item, index) in courses" :key="index" class="lwq-item" @click="onClick(item)">
      <p class="lwq-title">{{item.title}}</p>
      <div class="lwq-time">
        <span class="lwq-duration" >
          <img class="lwq-clock" src="@/assets/images/icon-time.png" alt />
